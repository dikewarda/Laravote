                    ...
                    <div class="card-body">
                        ...
                        <form enctype="multipart/form-data" action="{{route('candidates.update',['id'=>$candidate->id])}}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="visi" id="visi" class="form-control {{ $errors->first('visi') ? "is-invalid" : ""}}" placeholder="Visi">
                                <!-- <textarea name="visi"  id="visi" cols="5" rows="5" class="form-control {{ $errors->first('visi') ? "is-invalid" : ""}}"></textarea> -->
                                <p class="text-danger">{{ $errors->first('visi') }}</p>
                            </div>
                            <div class="form-group">
                                <label for="">Misi</label>
                                <input type="text" name="misi" id="misi" class="form-control {{ $errors->first('misi') ? "is-invalid" : ""}}" placeholder="Misi">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="program_kerja" id="program_kerja" class="form-control {{ $errors->first('program_kerja') ? "is-invalid" : ""}}" placeholder="Program Kerja">
                            ...
                            <div class="form-group">
                                ...
                                @if ($candidate->foto_paslon)
                                <img src="{{asset('storage/'.$candidate->foto_paslon)}}" width="100px"/>
                                @else
                                    No Cover
                                @endif
                                <input type="file" name="photo_paslon" id="foto_paslon" class="form-control {{ $errors->first('foto_paslon') ? "is-invalid" : ""}}">
                                <p class="text-danger">{{ $errors->first('foto_paslon') }}</p>
                            </div>
                            <div class="form-group">
