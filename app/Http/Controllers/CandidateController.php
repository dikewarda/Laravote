...
class CandidateController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $new_candidate->save();
        return redirect()->route('candidates.create')->with('status', 'Kandidat berhasil dibuat!');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $candidate->save();
        return redirect()->route('candidates.index')->with('status', 'Data berhasil diupdate!');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('candidates.index')->with('status', 'Data berhasil dihapus!');
    }
}
